...
public class EntityRendererMixin {
    ...
    @Definition(id = "dispatcher", field = "Lnet/minecraft/client/renderer/entity/EntityRenderer;entityRenderDispatcher:Lnet/minecraft/client/renderer/entity/EntityRenderDispatcher;")
    ...
    @WrapOperation(method = "shouldShowName", at = @At("MIXINEXTRAS:EXPRESSION"), allow = 1)
